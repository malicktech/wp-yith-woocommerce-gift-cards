...
if ( ! class_exists ( "YITH_YWGC_Email_Send_Gift_Card" ) ) {
	...
	class YITH_YWGC_Email_Send_Gift_Card extends WC_Email {
		...
		public function __construct() {
			...
			$this->title = __ ( "YITH Gift Cards - Dispatch of the code", 'yith-woocommerce-gift-cards' );
			...
			$this->heading = apply_filters( 'yith_ywgc_email_heading_default_text', __ ( 'Your gift card', 'yith-woocommerce-gift-cards' ) );
		...
		public function trigger( $object ) {
            ...
            $this->introductory_text = apply_filters( 'yith_ywgc_email_introductory_text', $this->get_option ( 'introductory_text', __ ( 'Hi {recipient_name}, you have received this gift card from {sender}, use it on our online shop.', 'yith-woocommerce-gift-cards' ) ), $object->present_product_id ) ;
